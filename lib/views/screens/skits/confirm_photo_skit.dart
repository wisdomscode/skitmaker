...
class ConfirmVideoSkitPage extends StatefulWidget {
  const ConfirmVideoSkitPage(
  ...
  @override
  State<ConfirmVideoSkitPage> createState() => _ConfirmVideoSkitPageState();
}

class _ConfirmVideoSkitPageState extends State<ConfirmVideoSkitPage> {
